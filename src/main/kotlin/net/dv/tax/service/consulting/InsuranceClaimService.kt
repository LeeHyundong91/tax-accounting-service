...
class InsuranceClaimService(
    ...
    fun makeData(hospitalId: String, year: String) {
        ...
        insuranceClaimRepository.findTopByHospitalIdAndResultYearMonthStartingWith(hospitalId, year)
            ?: insuranceClaimRepository.save(data).apply {
                ...
                insuranceClaimRepository.save(this)
            }
    }
