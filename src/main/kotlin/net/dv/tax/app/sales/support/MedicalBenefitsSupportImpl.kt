...
import net.dv.tax.app.dto.sales.MedicalBenefitsDto
...
class MedicalBenefitsSupportImpl(
    ...
    override fun monthlyCorpSumAmount(hospitalId: String, yearMonth: String): Long? {
        return query
            .select(
    ...
    override fun monthlyOwnChargeSumAmount(hospitalId: String, yearMonth: String): Long? {
        return query
            .select(
                medicalBenefitsEntity.decisionADOwnCharge.sum()
            ).from(medicalBenefitsEntity)
            .where(
                medicalBenefitsEntity.hospitalId.eq(hospitalId),
                medicalBenefitsEntity.treatmentYearMonth.startsWith(yearMonth)
