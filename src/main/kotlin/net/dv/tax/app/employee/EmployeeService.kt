    ...
    fun registerEmployeeRequest(employeeRequestDto: EmployeeRequestDto): Int {
        ...
        employeeRequestDto?.also { employeeRequest ->
            ...
            var saveEmployeeRequestEntity = EmployeeRequestEntity(
                ...
                careerBreakYn = employeeRequest.careerBreakYn,
                spec = employeeRequest.spec,
                academicHistory = employeeRequest.academicHistory,
                contractDuration = employeeRequest.contractDuration,
                ...
                enlistmentAt = employeeRequest.enlistmentAt,
                dischargeAt = employeeRequest.dischargeAt,
                workRenewalAt = employeeRequest.workRenewalAt,
    ...
    fun getEmployeeRequestList(hospitalId: String, employeeQueryDto: EmployeeQueryDto): EmployeeRequestReturnDto {
        ...
        val employeeRequestList = employeeRequestRepository.employeeRequestList(hospitalId, employeeQueryDto).map {
            EmployeeRequestDto(
                ...
                name = it.name,
                careerBreakYn = it.careerBreakYn,
                spec = it.spec,
                academicHistory = it.academicHistory,
                ...
                reason = it.reason ?: "",
                job = it.job,
                dependentCnt = it.dependentCnt,
                enlistmentAt = it.enlistmentAt,
                careerNumber = it.careerNumber,
                dischargeAt = it.dischargeAt,
                workRenewalAt = it.workRenewalAt,
                resignationAt = it.resignationAt,
                resignationContents = it.resignationContents,
